      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="flex items-center justify-center gap-3 mb-4">
            <GitCompare className="w-12 h-12 text-cosmic-purple" />
        ...
        <motion.div
          ...
          className="mt-12 bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl p-8 border border-gray-700 overflow-x-auto"
        >
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-700">
                ...
                {pamTools.map((tool) => (
                  <th key={tool.id} className="text-center py-3 px-4 text-gray-300 font-semibold">
                    {tool.vendor}
                  </th>
                ))}
              </tr>
            ...
            <tbody>
              <tr className="border-b border-gray-700/50">
                <td className="py-3 px-4 text-gray-300">Session Recording</td>
                {pamTools.map((tool) => (
              ...
              <tr className="border-b border-gray-700/50">
                <td className="py-3 px-4 text-gray-300">JIT Access</td>
                {pamTools.map((tool) => (
                  <td key={tool.id} className="text-center py-3 px-4">
              ...
              <tr className="border-b border-gray-700/50">
                <td className="py-3 px-4 text-gray-300">Azure AD Integration</td>
                {pamTools.map((tool) => (
                  <td key={tool.id} className="text-center py-3 px-4">
              ...
              <tr className="border-b border-gray-700/50">
                <td className="py-3 px-4 text-gray-300">SIEM Integration</td>
                {pamTools.map((tool) => (
                  <td key={tool.id} className="text-center py-3 px-4">
              ...
              <tr className="border-b border-gray-700/50">
                <td className="py-3 px-4 text-gray-300">Threat Detection</td>
                {pamTools.map((tool) => (
                  <td key={tool.id} className="text-center py-3 px-4">
              ...
              <tr>
                <td className="py-3 px-4 text-gray-300">Implementation Complexity</td>
                {pamTools.map((tool) => (
                  <td key={tool.id} className="text-center py-3 px-4 text-gray-300">
