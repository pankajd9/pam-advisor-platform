      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {loading && (
          ...
          >
            ...
            <p className="text-gray-300 mt-4 text-lg">Analyzing your requirements...</p>
          ...
          >
            <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl p-8 border border-slate-700 shadow-xl">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-white">Tell Us About Your Requirements</h2>
              </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="space-y-2">
                        <h4 className="text-sm font-semibold text-gray-300">Why this recommendation:</h4>
                    ...
                    <div className="mt-4 pt-4 border-t border-slate-700">
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                        <div className="text-center">
                          <div className="text-lg font-bold text-cyan-400">{rec.scores.feature_score.toFixed(0)}</div>
                          <div className="text-xs text-gray-400">Features</div>
                        </div>
                        <div className="text-center">
                          <div className="text-lg font-bold text-cyan-400">{rec.scores.compliance_score.toFixed(0)}</div>
                          <div className="text-xs text-gray-400">Compliance</div>
                        </div>
                        <div className="text-center">
                          <div className="text-lg font-bold text-cyan-400">{rec.scores.scalability_score.toFixed(0)}</div>
                          <div className="text-xs text-gray-400">Scalability</div>
                        </div>
                        <div className="text-center">
                          <div className="text-lg font-bold text-cyan-400">{rec.scores.budget_score.toFixed(0)}</div>
                          <div className="text-xs text-gray-400">Budget Fit</div>
                        </div>
                      </div>
                    </div>
                  </div>
